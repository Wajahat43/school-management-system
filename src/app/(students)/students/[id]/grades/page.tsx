import { fetchFormattedGradesByStudentId } from "@/app/(students)/_actions/student-actions";
import StudentGradesTable from "@/app/(students)/_components/student-grades-table";
